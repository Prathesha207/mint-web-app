    ...
    theme: {
        extend: {
            fontSize: {
                ...
                '5xl': ['3rem', { lineHeight: '1.1', letterSpacing: '0.002em', fontWeight: '800' }],
                ...
                '8xl': ['6rem', { lineHeight: '1.05', letterSpacing: '0.0005em', fontWeight: '900' }],
                '9xl': ['8rem', { lineHeight: '1.05', letterSpacing: '0.0002em', fontWeight: '900' }],
            },
            fontFamily: {
                heading: "syne",
            ...
            colors: {
                ...
                'accent-muted': '#A8D5BA',
                'accent-muted-foreground': '#1A3A2A',
                'glass-background': 'rgba(245, 245, 245, 0.7)',
                'glass-foreground': '#7A8A8A',
                background: '#F8F9FA',
                secondary: '#9B7EBD',
                foreground: '#2C3E50',
