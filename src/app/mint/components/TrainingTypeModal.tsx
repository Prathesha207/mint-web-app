        ...
        >
          ...
          {selectedTrainingModel && (
            <div className="mb-3 p-2 bg-blue-500/10 border border-blue-500/20 rounded-lg">
              <div className="text-[9px] font-bold text-blue-400 uppercase tracking-widest">Training Model</div>
              <div className="text-[10px] text-blue-300 break-all">{selectedTrainingModel}</div>
            </div>
          )}
