...
interface InferenceControlsProps {
  ...
  isStoppingBackendVideo?: boolean;
  ...
  activeInferenceRoiLabel?: string;
  hasRuntimeInferenceRois?: boolean;
  hasClientSideOnlyInferenceRoi?: boolean;
...
export default function InferenceControls({
  ...
  connectionError,
  isProcessing,
  isStoppingBackendVideo = false,
  inferenceWarning,
  backendVideoStatus,
  uploadedVideoInfo,
  activeInferenceRoiLabel = '',
  hasRuntimeInferenceRois = false,
  hasClientSideOnlyInferenceRoi = false,
  predictions,
  inferenceStats,
  ...
  // Check if we have a valid input source for inference
  const hasValidInputSource =
    (inputSource === 'upload' && videoFile && !isRealtime) ||
    (inputSource === 'camera' || inputSource === 'oak' || inputSource === 'remote');
            ...
            <div className="space-y-3 rounded-lg border border-white/5 bg-black/20 p-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  disabled={isStoppingBackendVideo}
              ...
              {!isRealtime ? (
                <>
                  ...
                  <div className="text-[11px] text-zinc-500">
                    {hasRuntimeInferenceRois
                      ? `Backend video inference will apply ${activeInferenceRoiLabel ? `"${activeInferenceRoiLabel}"` : 'the drawn ROI overlay'} and keep anomaly output inside the drawn region.`
          ...
          {activeTab === 'live' ? (
            <div className="space-y-2">
              <button
                ...
                className={`w-full rounded-lg py-2.5 text-[10px] font-bold uppercase tracking-widest transition-colors ${isStoppingBackendVideo
              ...
              <button
                ...
                disabled={!selectedModel || isProcessing || modelLoading || connectionError || isStoppingBackendVideo}
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                disabled={!selectedModel || batchFiles.length === 0 || isBatchProcessing || modelLoading || isStoppingBackendVideo}
